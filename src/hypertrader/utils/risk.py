...
def kill_switch(current_drawdown: float, max_drawdown: float = 0.25) -> bool:
    """Determine whether trading should be halted due to drawdown breach.
    
    Parameters
    ----------
    current_drawdown : float
        Current drawdown as a fraction (e.g., 0.1 for 10%)
    max_drawdown : float
        Maximum acceptable drawdown before halting (default 0.25 for 25%)
